package screens 
{
	...
	public class PlayState extends FlxState 
	{
		...
		override public function create():void 
		{
			...
			this._world.getSystemManager().addSystem(new PlayerEntitySystem(PlayerComponent));
			...
			var playerSprite:FlxSprite = PlayerComponent(player.getComponent(ComponentTypeManager.getTypeFor(PlayerComponent))).getSprite();
